      ...
      <div className="Landing">
        ...
        <div className="Landing__btns">
          <Link 
            ...
            style={{textDecoration: 'none', color: '#FFF'}} className="Landing__btn--green Landing-btns"> 
            Accept 
          </Link>
          <Link 
            to={{pathname: "/home"}} 
            onClick={() => this.props.handleGeolocation(false)}
            style={{textDecoration: 'none', color: '#FFF'}} className="Landing__btn--red Landing-btns"> 
            Decline 
          </Link>
        </div>
      </div>
